...
function App() {
  ...
  return (
        ...
        <div
          ...
          data-aos-delay="400"
        >
          <svg className="max-w-full" width="490" height="552" viewBox="0 0 564 552" fill="none" xmlns="http://www.w3.org/2000/svg"  >
            <defs>
        ...
        <div>
            <div className="max-w-6xl mx-auto relative text-center pt-32 pb-10 md:pt-40 md:pb-16">  
			<h3 className='h3'>
			Upload your files here
			</h3>
            </div>
			
                <form action="http://127.0.0.1:5000/form-image">
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                      <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="full-name">Full Name <span className="text-red-600">*</span></label>
                      <input name="fname" id="full-name" type="text" className="form-input w-medium text-gray-300" placeholder="First name" required 
                      value = {user.fname}
                      onChange = {handleInputs}
                      />
                    </div>
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="aa">Aadhar Number<span className="text-red-600">*</span></label>
				        <input name="aadharn" className="form-input w-medium text-gray-300" placeholder = "Adhaar number" type="text"  value = {user.aadharn}
                onChange = {handleInputs}  required/>
                </div>
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <label className="block text-gray-300 text-xl font-medium mb-1 md:pb-7" htmlFor="aa">Upload path to Aadhar Card</label>
				        <input name="aadhar" id="aadhar "className="form-input w-medium text-gray-300"type="text" required
                value = {user.aadhar}
                onChange = {handleInputs}
                />
                </div>
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <label className="block text-gray-300 text-sm font-medium mb-1" htmlFor="bc">Pan card Number<span className="text-red-600">*</span></label>
				        <input name="pann"placeholder = "Pan card Number" className="form-input w-medium text-gray-300"type="text" value = {user.pann}
                onChange = {handleInputs} required/>
                </div>
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <label className="block text-gray-300 text-xl font-medium mb-1" htmlFor="bc">Upload path to Pan Card</label>
				        <input name="pan"className="form-input w-medium text-gray-300" id="pan" type="text" required
                value = {user.pan}
                onChange = {handleInputs}
                />
                </div> 
                ...
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <button className="btn text-white  bg-purple-600 hover:bg-purple-700 w-sm">
				Upload
				</button>
